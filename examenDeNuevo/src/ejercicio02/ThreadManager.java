...
public class ThreadManager {
    ...
    public void startThreads() {
    	Thread t1 = new Thread(new CountDown("C-1", 10), "C1");
    	threads.add(t1);
    	Thread t2 = new Thread(new CountDown("C-2", 10), "C2");
    	threads.add(t2);
    	Thread t3 = new Thread(new CountDown("C-3", 10), "C3");
    	threads.add(t3);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("1: El estado RUNNABLE es frecuente porque los hilos están listos para ejecutarse y esperando tiempo de CPU.");
        System.out.println("2: El estado TIMED_WAITING es frecuente debido a las llamadas a Thread.sleep(milis), que hacen que los hilos esperen durante un tiempo específico.");
        System.out.println("3: El estado TERMINATED es frecuente al final del ciclo de vida del hilo, después de que ha completado su tarea.");  
    }
}
